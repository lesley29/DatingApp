...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20201128123015_RefactorUserModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Aggregates.User.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Aggregates.User.Entities.User", b =>
                {
                    b.OwnsOne("Domain.Aggregates.User.ValueObjects.Password", "Password", b1 =>
                        {
                    ...
                    b.OwnsMany("Domain.Aggregates.User.ValueObjects.Photo", "Photos", b1 =>
                        {
                            b1.Property<int>("UserId")
                                .HasColumnType("integer")
